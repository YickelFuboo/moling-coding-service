...
@router.post("/{repository_id}/wiki/generate")
async def generate_repository_wiki(
    ...
    try:
        ...
        # 启动wiki生成任务
        from app.domains.repo_mgmt.tasks.wiki_task import generate_wiki_task
        generate_wiki_task.delay(repository_id)
        
        return {"message": "Wiki生成任务已启动", "repository_id": repository_id}
